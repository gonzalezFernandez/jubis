...
function buildDobletazo() {
  ...
  html += `</div>`;
  if (S.pid === 'fita' && pct > 75 && !triple) html += `<div class="wsk-active" style="background:rgba(155,66,240,.25);border-color:rgba(155,66,240,.6);color:#c97fff">🌙 JUEVES DE FINHA ×1.5 — energía por encima del 75%</div>`;
