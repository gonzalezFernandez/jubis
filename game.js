...
const ACHIEVEMENTS = {
  ...
  diego: [
    ...
    { id:'silencio',         icon:'😶', name:'Silencio Incómodo',     desc:'Diego pierde el hilo. Pasa pocas veces pero pasa.',           cond: s => (s.achData.silenciosIncomodos||0) >= 1 && (s.achData.chapaMax||0) >= 50 },
